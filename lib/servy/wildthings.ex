defmodule Servy.Wildthings do
  ...
  def list_bears do
    [
      ...
      %Bear{id: 5, name: "Snow", type: "Polar", hibernating: true},
      %Bear{id: 6, name: "Brutus", type: "Grizzly"},
      %Bear{id: 7, name: "Rosie", type: "Black", hibernating: true},
      %Bear{id: 8, name: "Roscoe", type: "Panda", hibernating: true},
      %Bear{id: 9, name: "Iceman", type: "Polar"},
      %Bear{id: 10, name: "Kenai", type: "Grizzly", hibernating: true}
    ]
  end
