defmodule HandlerTest do
  ...
  test "GET /api/bears" do
    ...
    Content-Length:602\r
    \r
    [{"hibernating":true,"type":"Brown","name":"Teddy","id":1},
      {"hibernating":true,"type":"Black","name":"Smokey","id":2},
      {"hibernating":false,"type":"Brown","name":"Paddington","id":3},
      {"hibernating":true,"type":"Grizzly","name":"Scarface","id":4},
      {"hibernating":true,"type":"Polar","name":"Snow","id":5},
      {"hibernating":false,"type":"Grizzly","name":"Brutus","id":6},
      {"hibernating":true,"type":"Black","name":"Rosie","id":7},
      {"hibernating":true,"type":"Panda","name":"Roscoe","id":8},
      {"hibernating":false,"type":"Polar","name":"Iceman","id":9},
      {"hibernating":true,"type":"Grizzly","name":"Kenai","id":10}]
    """
